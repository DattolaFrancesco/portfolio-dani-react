...
const Works = () => {
  ...
  const works06 = ["/img-works06/1_MISC.jpg", "/img-works06/2_MISC.jpg", "/img-works06/3_MISC.jpg", "/img-works06/4_MISC.jpg"];
          ...
          <div key={i} className={`${i === 0 ? "mt-4" : ""}`}>
            ...
            <section className={i === 5 ? "mb-5" : ""}>
              ...
              <div id={titles[i]} className="carousel slide">
                ...
                <div className={`carousel-inner ${i === 1 ? "" : "shadow-custom"}`} style={{ height: i === 2 ? "47vh" : "60vh" }}>
                  {e.map((e, i) => {
                    return (
